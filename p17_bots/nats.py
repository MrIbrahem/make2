...
import re
from .. import printe
from ..malists_bots import sport_formts_for_p17, nat_p17_oioi
from ..malists_bots import fanco_line, Sports_Keys_For_Team
from ..matables_bots.bot import New_players, Add_to_main2_tab  # Add_to_main2_tab()
from .. import malists_sport_lab as sport_lab
from ..malists_bots import All_Nat, Nat_women
